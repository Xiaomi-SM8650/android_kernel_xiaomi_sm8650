 ...
 */
#define LOGD(log, ...) pr_debug("[  debug] %s: " log, __func__, ##__VA_ARGS__)
#define LOGI(log, ...) pr_info("[   info] %s: " log, __func__, ##__VA_ARGS__)
#define LOGN(log, ...) pr_notice("[   info] %s: " log, __func__, ##__VA_ARGS__)
#define LOGW(log, ...) pr_warn("[warning] %s: " log, __func__, ##__VA_ARGS__)
#define LOGE(log, ...) pr_err("[  error] %s: " log, __func__, ##__VA_ARGS__)
