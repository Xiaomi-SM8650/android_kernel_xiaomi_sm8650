...
KBUILD_CFLAGS   := -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs \
		   ...
		   -Werror=return-type -Wno-format-security -Wno-format\
		   -std=gnu11
...
ext-mod-dirs := $(ext-mod-dir)/qcom/opensource/audio-kernel $(ext-mod-dir)/qcom/opensource/display-drivers $(ext-mod-dir)/qcom/opensource/video-kernel $(ext-mod-dir)/nxp/opensource/driver $(ext-mod-dir)/st/opensource/driver $(ext-mod-dir)/st/opensource/eSE-driver $(ext-mod-dir)/qcom/opensource/dataipa/drivers/platform/msm
